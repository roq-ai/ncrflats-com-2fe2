...
type ColumnType = ColumnDef<SellerInterface, unknown>;
...
export function SellerListPage(props: SellerListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<SellerInterface>>(
    () => `/sellers?params=${JSON.stringify(params)}`,
    fetcher,
  );
...

    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/sellers/view/${record.id}`} passHref legacyBehavior>
            <Button
